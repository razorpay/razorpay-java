...
public class PaymentClient extends ApiClient {
  ...
  PaymentClient(String auth,ApiUtils apiUtils) {
    super(auth,apiUtils);
    refundClient = new RefundClient(auth,apiUtils);
  }

  public Payment fetch(String id) throws RazorpayException, JSONException, IOException, URISyntaxException {
  ...
  public List<Refund> fetchAllRefunds(String id) throws RazorpayException, JSONException, IOException, URISyntaxException {
  ...
  public List<Transfer> transfer(String id, JSONObject request) throws RazorpayException, JSONException, IOException, URISyntaxException {
    return postCollection(String.format(Constants.PAYMENT_TRANSFER_CREATE, id), request);
